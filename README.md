...
`http://localhost:3000/` and upload your json file, the server will respond with ip and mac address details along with tcp/udp port numbers. Edit the functions in `packetAnalyzer.js` to get your own customized output.
