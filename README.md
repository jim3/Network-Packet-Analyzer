...
From here on out, I plan to focus exclusively on the database portion of the project. I do plan to implement a table or chart to display the data but it's *low priority* and *only* when I have the time. 
